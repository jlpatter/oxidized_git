...
class Main {
    ...
    constructor() {
        this.utils = null;
        this.updater = null;
        // TODO: Move svgManager to repoView!
    ...
    async loadModules() {
        this.utils = await import("./modules/utils.js");
        ...
        const repoViewModule = await import("./modules/repoView.js");
        this.repoView = new repoViewModule.RepoView(this);
    ...
    run() {
        ...
        $(window).resize(() => {
            self.repoView.truncateFilePathText();
